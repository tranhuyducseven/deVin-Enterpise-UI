...
import { SubstrateContextProvider, useSubstrate, useSubstrateState } from "./substrate-lib";
...
const Dashboard = (props) => {
  ...
  const message = (err) => (
    <Grid centered columns={2} padded>
      <Grid.Column>
        <Message negative compact floating header="Error Connecting to Substrate" content={`${err}`} />
      </Grid.Column>
    </Grid>
  );
